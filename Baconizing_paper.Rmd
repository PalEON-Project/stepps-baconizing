...
if (paste0('pubs_v', settings$version, '.rds') %in% list.files('data/output')) {
...
hists <- chronology_type_histogram(meta.table)
...
if(paste0('controls_', settings$version, '.rds') %in% list.files('data/output/rds_files/')) {
  controls <- readRDS(paste0('data/output/rds_files/controls_', settings$version, '.rds'))
} else {
  ...
  saveRDS(controls, paste0('data/output/rds_files/controls_', settings$version, '.rds'))
}
...
all_geochron <- readRDS(paste0('data/output/all_geochron_v', settings$version, '.rds'))
