...
Recent efforts with the European Pollen Database have focused on standardizing age models across the database [@giesecke2014towards]. These models used the software Clam [@blaauw2010methods], as did efforts with the North American Pollen Database [@blois2011methodological].  In both these cases, models were regenerated for records, although [something needed here.] 
