...
ggplot(leads[is.na(leads$e.older),], aes(x = age)) + 
  geom_histogram(fill = 'red', alpha = 0.5, color = 'black') +
  geom_point(data = leads, aes(x = age, y = e.older), alpha = 0.3) + 
  geom_smooth(data = leads, aes(x = age, y = e.older)) +
  coord_cartesian(xlim = c(0, 200), ylim = c(0, 150), expand = c(0, 0))
