...
if ('pubs.RData' %in% list.files('data/output')) {
  load('data/output/pubs.RData')
} else {
 pubs <- neotoma::get_publication(all.datasets)
 
 save(pubs, file = 'data/output/pubs.RData')
}
