...
Diving a core into sections is in essence a time discretization, and we felt that it was important to use a consistent discretization for all cores. However, in practice this is not as simple as it sounds. Section thickness affects run-time, model flexibility, and, in certain cases, the ability of Bacon to successful fit a model.  Given the flexibility in assigning section thicknesses, and the dependence
